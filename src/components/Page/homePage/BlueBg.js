        ...
        <>
            ...
            <main className='tw-bg-[#0060b4] tw-text-white tw-py-16 md:tw-px-36 lg:tw-p-0 lg:tw-pt-24 lg:tw-flex tw-items-end'>
                ...
                <section className='lg:tw-w-[70%] lg:tw-pl-20 lg:tw-pb-36 xl:tw-pl-36 tw-font-PuviMedium'>
                    <p className='tw-text-center lg:tw-text-left tw-text-3xl lg:tw-text-5xl tw-font-medium lg:tw-font-normal'>Made for the <strong>Global</strong></p>
                    ...
                    <div className='sm:tw-grid tw-grid-cols-2 sm:tw-mt-10 '>
                        <div className='tw-text-center tw-mt-14 sm:tw-mt-5 lg:tw-flex lg:tw-items-center '>
                            ...
                            <p className='  lg:tw-text-left lg:tw-border-b'>Users <br className='tw-hidden lg:tw-inline' /> Services</p>
                        </div>
                        ...
                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-flex lg:tw-items-center '>
                            ...
                            <p className='  lg:tw-text-left lg:tw-border-b'>Countries <br className='tw-hidden lg:tw-inline' />Years in Business</p>
                        </div>

                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-flex lg:tw-items-center '>
                            <p className='tw-text-3xl tw-font-medium tw-tracking-wide lg:tw-w-32 '>12+</p>
                            <p className='  lg:tw-text-left lg:tw-border-b'>Employees  <br className='tw-hidden lg:tw-inline' />Countries Served</p>
                        </div>

                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-flex lg:tw-items-center '>
                            <p className='tw-text-3xl tw-font-medium tw-tracking-wide lg:tw-w-32 '>150+</p>
                            <p className='  lg:tw-text-left lg:tw-border-b'>Years in  <br className='tw-hidden lg:tw-inline' />Support Centers Globally</p>
                        </div>

                        <div className='tw-text-center lg:tw-text-left tw-mt-14 sm:tw-mt-5 lg:tw-flex lg:tw-items-center '>
                            <p className='tw-text-3xl tw-font-medium tw-tracking-wide lg:tw-w-32 '>20+</p>
                            <p className='  lg:tw-text-left lg:tw-border-b'>Unique Solutions</p>
                        </div>
