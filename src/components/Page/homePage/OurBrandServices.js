    ...
    return (
        <>
            ...
            <div className='tw-p-5 tw-ml-16 '>
                ...
                >
                    <section className='tw-shadow-xl tw-bg-[#dcf7ff] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] tw-pr-10 '>
                        {/* <img src={brand_service_6} alt="" /> */}
                        <p className=''><span className='tw-font-bold tw-mt-3 tw-text-xl tw-font-PuviExtraBold'>FAUCONE</span> <span className='tw-text-xl tw-font-PuviMedium'>BUSINESS</span></p>
                    ...
                    <section className='tw-shadow-xl tw-bg-[#f2f2f2] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                        <p className=''><span className='tw-font-bold tw-mt-3 tw-text-xl tw-font-PuviExtraBold'>FAUCONE</span> <span className='tw-text-xl tw-font-PuviMedium'>DIGITAL</span></p>
                    ...
                    <section className='tw-shadow-xl tw-bg-[#ffe6e6] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                        <p className=''><span className='tw-font-bold tw-mt-3 tw-text-xl tw-font-PuviExtraBold'>FAUCONE</span> <span className='tw-text-xl tw-font-PuviMedium'>TECHNOLOGIES</span></p>
                    ...
                    <section className='tw-shadow-xl tw-bg-[#d6f5d6] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                        <p className=''><span className='tw-font-bold tw-mt-3 tw-text-xl tw-font-PuviExtraBold'>FAUCONE</span> <span className='tw-text-xl tw-font-PuviMedium'>SOLUTIONS</span></p>
                    ...
                    <section className='tw-shadow-xl tw-bg-[#f5edd6] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#e0ebeb] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#e6ccff] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#ffd6cc] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#f9ecf2] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#e6e6ff] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#f2d9d9] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#e6ffee] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
                    ...
                    <section className='tw-shadow-xl tw-bg-[#f5d6d6] tw-border-[8px] tw-py-10 tw-px-8 tw-border-white tw-rounded-2xl tw-h-[100%] '>
                        {/* <img src={brand_service_6} alt="" /> */}
